    ...
    switch (loca.pathname) {
      ...
      case "/Vacations":
        setData({
          title: "اخر الاجازات",
          totalPublished: 8,
          publishedBooks: [{ id: 3, title: "اجازة" }],
        });
        break;
      case "/Divisions":
        setData({
          title: "الشعب",
          publishedBooks: [{ id: 2, title: "اجازة" }],
        });
        break;
      default:
          ...
          <div>
            <div className="info">
              <div className="tex">
                <h3>{data.title}</h3>
                <p>
                  عدد الاجازات الكلي : <span>{lengthCard}</span>
                </p>
              </div>
            </div>
            <hr />
          ...
          <div>
            <div className="info">
              <div className="tex">
                <h3>{data.title}</h3>
                <p>
                  عدد الكتب الكلي : <span>{data.totalReceived}</span>
                </p>
              </div>
              <div className="divs">
                <div>
          ...
          <div>
            <div className="info">
              <div className="tex">
                <h3>{data.title}</h3>
                <p>
                  عدد الكتب الكلي : <span>{data.totalPublished}</span>
                </p>
              </div>
              <div className="divs">
                <div>
          ...
          <div>
            <div className="info">
              <div className="tex">
                <h3>{data.title}</h3>
                <p>
                  عدد الشعب الكلي : <span>{sectionLength}</span>
                </p>
              </div>
            </div>
            <hr />
